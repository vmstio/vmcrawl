...
CREATE TABLE
  raw_domains (
    ...
    bad_mau BOOLEAN DEFAULT NULL,
    nodeinfo TEXT DEFAULT NULL,
    alias BOOLEAN DEFAULT NULL
  );

-- Migration for existing databases:
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_dns BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_ssl BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_tcp BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_type BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_file BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_api BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_json BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_http2xx BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_http3xx BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_http4xx BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_http5xx BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_hard BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_robot BOOLEAN DEFAULT NULL;
-- ALTER TABLE raw_domains ADD COLUMN IF NOT EXISTS bad_mau BOOLEAN DEFAULT NULL;
--
-- ALTER TABLE raw_domains DROP COLUMN IF EXISTS baddata;
-- ALTER TABLE raw_domains DROP COLUMN IF EXISTS failed;
-- ALTER TABLE raw_domains DROP COLUMN IF EXISTS ignore;
-- ALTER TABLE raw_domains DROP COLUMN IF EXISTS nxdomain;
-- ALTER TABLE raw_domains DROP COLUMN IF EXISTS norobots;
-- ALTER TABLE raw_domains DROP COLUMN IF EXISTS noapi;
